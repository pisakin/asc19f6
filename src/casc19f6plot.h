#ifndef CASC19F6PLOT_H
#define CASC18F6PLOT_H
...
class CASC19F6Plot : public QFrame
{
  Q_OBJECT
public:
  explicit CASC19F6Plot(QWidget *parent = nullptr);
    ~CASC19F6Plot();
...
//
  ...
  QGroupBox *createBoxInput     (void);
  QGroupBox *createBoxGeneral   (void);
  QGroupBox *createBoxFooter    (void);
  void procPlotPumpQI           (void);
  void procPlotPumpIA           (void);
  void procPlotPl               (void);
  void procPlotMn               (void);
