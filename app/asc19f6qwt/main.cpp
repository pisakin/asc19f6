#include "../../src/cascemtypes.h"
#include "../../src/cascemqwt.h"
...
//
    QCoreApplication::setOrganizationName("ascEMQWT");
    QCoreApplication::setOrganizationDomain("pisakin.com");
    QCoreApplication::setApplicationName("ascEMQWT");
